...
<!-- LEE EDITS REPLACE SHOP BUTTON -->
	...
	<a href="https://panaceacreative.com/demos/wordpress3/flyers/" class="logo <?php if($without_logo) echo ' logo-without-image'; ?>">
        ...
        <?php else: ?>
<!-- LEE EDITS CHANGE BUTTON NAME -->
        <?php esc_html_e('Back','web-to-print-online-designer'); ?>
<!-- ENDS -->
        <?php endif; ?>
    </a>
...
<!-- LEE EDITS SHOW MENU ITEMS FOR ADMIN ONLY-->
					<?php
...
<!-- LEE EDITS ADD SAVE AS DIALOGUE -->
                 ...
                 <?php if( $settings['allow_customer_download_design_in_editor'] == 'yes' && ( $settings['nbdesigner_download_design_in_editor_png'] == '1' || $settings['nbdesigner_download_design_in_editor_pdf'] == '1' || $settings['nbdesigner_download_design_in_editor_jpg'] == '1' || $settings['nbdesigner_download_design_in_editor_svg'] == '1' ) ): ?>
                    <li class="sub-menu-item flex space-between hover-menu" data-animate="bottom-to-top">
                        <span class="title-menu"><?php esc_html_e('Save As...','web-to-print-online-designer'); ?></span>
                        <small>{{ 'M-S' | keyboardShortcut }}</small>
                        <i class="icon-nbd icon-nbd-arrow-drop-down rotate-90"></i>
                        <div class="hover-sub-menu-item">
                            <ul>
                        <li class="sub-menu-item flex space-between" ng-click="saveAs()">
...
<!-- ENDS -->
        ...
        <li class="menu-item item-edit">
            ...
            <div class="sub-menu" data-pos="left">
                <ul>
<!-- LEE EDITS HIDE CLEAR ALL DESIGN AND SAVE FOR LATER -->
...
<!-- LEE EDITS TURN ON SNAP TO FEATURE -->
